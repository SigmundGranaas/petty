...
fn main() -> Result<(), PipelineError> {
    // UPDATED: Use the new Profiler API as per the latest docs
    #[cfg(feature = "dhat-heap")]
    ...
    println!("Running Advanced Performance Test Example...");
    ...
    // The `generate_to_file` method will internally time and report on the
    // individual stages (Parsing/Layout and PDF Finalization). This outer
    // timer measures the total wall-clock time including file I/O.
