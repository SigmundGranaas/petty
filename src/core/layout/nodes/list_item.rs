...
use crate::core::layout::node::{
    LayoutNode, LayoutResult, ListItemState, NodeState, RenderNode,
};
...
use crate::core::layout::{
    geom, LayoutContext, LayoutElement, LayoutEngine, LayoutEnvironment, LayoutError,
    ...
    pub fn new(
        ...
        for child_ir in &children_to_process {
            if let IRNode::List { .. } = child_ir {
                children.push(RenderNode::List(Box::new(super::list::ListNode::new_with_depth(
                    child_ir,
                    engine,
                    style.clone(),
                    depth + 1,
