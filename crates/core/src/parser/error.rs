...
// Convert XPath errors from petty-xpath1 to ParseError
impl From<crate::xpath::XPathError> for ParseError {
    fn from(e: crate::xpath::XPathError) -> Self {
        ParseError::XPathParse(e.to_string(), String::new())
    }
}

// Convert style parsing errors from petty-style to ParseError
impl From<petty_style::parsers::StyleParseError> for ParseError {
    fn from(e: petty_style::parsers::StyleParseError) -> Self {
        ParseError::TemplateParse(e.to_string())
    }
}